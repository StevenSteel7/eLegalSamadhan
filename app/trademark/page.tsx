                ...
                <div  className="max-w-7xl mx-auto p-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <CallbackForm
                                ...
                                buttonText="Request Callback for Trademark Registration"
                                />
                ...
                <div className="max-w-7xl mx-auto p-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <CallbackForm
                                ...
                                buttonText="Request Callback for Patent Registration"
                                />
                ...
                <div className="max-w-7xl mx-auto p-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <CallbackForm
                                ...
                                buttonText="Request Callback for Copyright Registration"
                                />
